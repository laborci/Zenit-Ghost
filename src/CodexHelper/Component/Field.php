...
namespace Zenit\Bundle\Ghost\CodexHelper\Component;
...
class Field{
	...
	public function getField(){ return "\t/** @var \Zenit\Bundle\Codex\Component\Codex\Field */ protected $" . $this->name . ";"; }

	public function getFieldConstructor(){
		return
			"\t\t\$this->" . $this->name . " = new \Zenit\Bundle\Codex\Component\Codex\Field('" . $this->name . "', '" . $this->translation->get($this->name) . "'"
